...
if [ ! -f /var/lib/libvirt/images/base-images/Fedora-Cloud-Base-38-1.6.x86_64.qcow2 ]; then
  curl -Lo /var/lib/libvirt/images/base-images/Fedora-Cloud-Base-38-1.6.x86_64.qcow2 https://download.fedoraproject.org/pub/fedora/linux/releases/38/Cloud/x86_64/images/Fedora-Cloud-Base-38-1.6.x86_64.qcow2
fi
...
virt-install --name database --autostart --noautoconsole --cpu host-passthrough \
             ...
             --disk path=/var/lib/libvirt/images/database/database.qcow2,backing_store=/var/lib/libvirt/images/base-images/Fedora-Cloud-Base-38-1.6.x86_64.qcow2,size=20 \
